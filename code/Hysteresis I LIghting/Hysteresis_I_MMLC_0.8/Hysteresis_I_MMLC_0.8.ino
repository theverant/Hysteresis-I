 ...
 *
 * Changelog:
 * - Slowed down fade routine and added varied fade speeds per LED for desynchronized effect.
 */
...
void loop() {
  ...
  // Slowly rotate color mapping over time, every 1000ms
  static unsigned long lastRotation = 0;
  if (currentMillis - lastRotation >= 1000) {
